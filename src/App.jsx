...
const saveKey = 'bowling-lane-alert.saved'
const postKey = 'bowling-lane-alert.posts'
const alerts = [
  {
    "id": "bowling-lane-alert-1",
    "title": "大会 alert seed 1",
    "area": "名古屋",
    "category": "大会",
    "score": 95,
    "summary": "大会、空きレーン、スコアランキング更新を通知し、施設送客、用品、イベント掲載へつなげる。 大会の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  {
    "id": "bowling-lane-alert-2",
    "title": "空きレーン alert seed 2",
    "area": "東京",
    "category": "空きレーン",
    "score": 92,
    "summary": "大会、空きレーン、スコアランキング更新を通知し、施設送客、用品、イベント掲載へつなげる。 空きレーンの条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール"
  ...
  {
    "id": "bowling-lane-alert-3",
    "title": "ランキング alert seed 3",
    "area": "大阪",
    "category": "ランキング",
    "score": 89,
    "summary": "大会、空きレーン、スコアランキング更新を通知し、施設送客、用品、イベント掲載へつなげる。 ランキングの条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール",
  ...
  {
    "id": "bowling-lane-alert-4",
    "title": "スコア alert seed 4",
    "area": "静岡",
    "category": "スコア",
    "score": 86,
    "summary": "大会、空きレーン、スコアランキング更新を通知し、施設送客、用品、イベント掲載へつなげる。 スコアの条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <p className="eyebrow">ボウリング大会・空きレーン通知</p>
          <h1>Bowling Lane Alert</h1>
          <p className="lead">大会、空きレーン、スコアランキング更新を通知し、施設送客、用品、イベント掲載へつなげる。</p>
        </div>
        <aside className="hero-panel">
          <span>lanealert.jp / bowling-lane-alert</span>
